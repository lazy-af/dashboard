...
const HStackBarChartWrapper = (props) => {
    ...
    useEffect(() => {
        if (!chart) {
            setChart(new D3HStackBarChart(chartArea.current, props.width, props.height, props.legend, props.legendWidth, props.colorScheme, props.xAxisLabel))
        } else {
            chart.update(data);
        }
    }, [chart, data, props.colorScheme, props.height, props.legend, props.legendWidth, props.width, props.xAxisLabel])
